...
MONSTERS = {
    ...
    204: Monster(360, 310, 20, 40),  # 史莱姆王
    205: Monster(35, 38, 3, 3),  # 小蝙蝠
    206: Monster(60, 100, 8, 12),  # 大蝙蝠
    207: Monster(200, 390, 90, 50),  # 吸血蝙蝠
    ...
    219: Monster(220, 370, 110, 80),  # 初级巫师
    220: Monster(200, 380, 130, 90),  # 高级巫师
    221: Monster(50, 48, 22, 12),  # 初级卫兵
    222: Monster(100, 180, 110, 50),  # 中级卫兵
    224: Monster(100, 680, 50, 55),  # 双手剑士
    225: Monster(210, 200, 65, 45),  # 战士
    226: Monster(120, 150, 50, 100),  # 骑士队长
    227: Monster(160, 230, 105, 65),  # 骑士
    228: Monster(180, 430, 210, 120),  # 黑暗骑士
    229: Monster(200, 380, 130, 90),  # 高级巫师
    246: Monster(230, 450, 100, 100),  # 魔法卫士
